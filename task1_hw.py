...
def date_format(data : str):
    day_first_pattern = re.compile(r'^(0?[1-9]|[12][0-9]|3[01])[-\.\/](0?[1-9]|1[012])[-\.\/]([0-9]{4})')
    year_first_pattern = re.compile(r'([0-9]{4})[-\.\/](0?[1-9]|1[012])[-\.\/](^0?[1-9]|[12][0-9]|3[01])')
    hungary_pattern = re.compile(r'([0-9]{4})[.\s]+(0?[1-9]|1[012])[.\s]+(^0?[1-9]|[12][0-9]|3[01])')
